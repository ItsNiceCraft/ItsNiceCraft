...
- [shibbo/Fushigi](https://github.com/shibbo/Fushigi) - An editor for Super Mario Bros. Wonder. (2 days ago)
- [httpcats/http.cat](https://github.com/httpcats/http.cat) - :cat: HTTP Cats API (5 days ago)
