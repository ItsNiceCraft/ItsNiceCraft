...
- [smuddgge/Leaf](https://github.com/smuddgge/Leaf) ([5.2.0](https://github.com/smuddgge/Leaf/releases/tag/5.2.0), 1 day ago) - Velocity Proxy Plugin | Friends | StaffChat | StaffList | ServerList | Report | Send | Alert | And more!
- [1Password/for-open-source](https://github.com/1Password/for-open-source) ([processor-2](https://github.com/1Password/for-open-source/releases/tag/processor-2), 4 days ago) - Get a 1Password team account for free to support your open source initiatives!
- [cotes2020/jekyll-theme-chirpy](https://github.com/cotes2020/jekyll-theme-chirpy) ([v7.0.1](https://github.com/cotes2020/jekyll-theme-chirpy/releases/tag/v7.0.1), 2 weeks ago) - A minimal, responsive, and feature-rich Jekyll theme for technical writing.
...
- [wei/socialify](https://github.com/wei/socialify) - 💞 Socialify your project. 🌐 Share with the world! (1 day ago)
- [repo-sync/repo-sync](https://github.com/repo-sync/repo-sync) - 🔄 Keep a pair of GitHub repos in sync (1 day ago)
- [wei/git-sync](https://github.com/wei/git-sync) - 🔃 A GitHub Action for syncing between two independent repositories using force push (1 day ago)
...
- [jitsi/jitsi-meet](https://github.com/jitsi/jitsi-meet) - Jitsi Meet - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application. (4 days ago)
