...
- [shibbo/Fushigi](https://github.com/shibbo/Fushigi) - An editor for Super Mario Bros. Wonder. (1 day ago)
- [httpcats/http.cat](https://github.com/httpcats/http.cat) - :cat: HTTP Cats API (4 days ago)
