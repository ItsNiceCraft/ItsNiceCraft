...
## // languages
![languages](https://skillicons.dev/icons?i=py,bash,godot,java)

## // tools

![tools](https://skillicons.dev/icons?i=vscode,visualstudio,idea,twitter,raspberrypi,nodejs,mongodb,linux,grafana,github,gitlab,gcp,aws,azure,fediverse,mastodon,discord,cloudflare,androidstudio,vercel)
