...
- [cotes2020/jekyll-theme-chirpy](https://github.com/cotes2020/jekyll-theme-chirpy) ([v6.5.1](https://github.com/cotes2020/jekyll-theme-chirpy/releases/tag/v6.5.1), 2 days ago) - A minimal, responsive, and feature-rich Jekyll theme for technical writing.
...
- [dsdanielpark/Gemini-API](https://github.com/dsdanielpark/Gemini-API) - The unofficial python package that returns response of Google Gemini through cookie values. (1 day ago)
- [lancachenet/monolithic](https://github.com/lancachenet/monolithic) - A monolithic lancache service capable of caching all CDNs in a single instance (3 days ago)
...
- [joelshepherd/tabliss](https://github.com/joelshepherd/tabliss) - A beautiful, customisable New Tab page for Firefox, Chrome, and Edge. (5 days ago)
